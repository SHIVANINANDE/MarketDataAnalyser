...
- **Date**: The date set by the company on which the investor must own shares.
- **Open**: The price at which trading begins for the day.
- **High**: The highest price at which a stock is traded during the specified period.
- **Low**: The lowest price of a stock during the specified period.
- **Close**: The price of an individual stock when the stock exchange closes for the day.
- **Adj Close**: The adjusted closing price that accounts for dividends and stock splits.
- **Volume**: An indicator of liquidity, representing the total number of shares traded during the specified period.
